...
?>
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #7DA25F;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item <?php if($page=='notes'){ echo 'active';}?> "" href="notes.php">Add Notes</a>
          <a class="dropdown-item" href="viewallnotes.php">View Notes</a>
        </div>
      </li>
      <li class="nav-item dropdown">
