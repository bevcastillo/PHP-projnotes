          ...
          <div class="col-8 mx-auto my-auto">
            ...
            <div class="card-body">
              <form action="process.php" method="POST">
                ...
                <button class="btn btn-danger btn-block mt-3" name="login" class="pt-3">Login</button>

                <div class="text-center mt-3 mb-3" style="font-size: 14px;">Doesn't have an account?
